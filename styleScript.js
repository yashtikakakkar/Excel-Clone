...
leftAlign.addEventListener("click", function () {
  if (lastCell) {
    lastCell.style.justifyContent = "left";
...
rightAlign.addEventListener("click", function () {
  if (lastCell) {
    lastCell.style.justifyContent = "right";
    let address = lastCell.getAttribute("data-address");
...
bgColorPicker.addEventListener("click", function () {
  ...
  // colorPickerElement.style.position = "fixed";
  // colorPickerElement.style.left = "82%";
  // colorPickerElement.style.top = "11vh";
  // colorPickerElement.style.visibility = "0";
